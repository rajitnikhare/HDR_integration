...
@Service
public class DataLoadCompanyODSToOSCSyncJob  extends AbstractSpringJob{
	
	
private static final Logger log =  Logger.getLogger(ProjectODSToOSCSyncJob.class);
	
	@Resource(name="dataLoadCompanyODSToOSC")
	...
	protected void executeJob() throws Exception {
		try {
			...
			log.error("In "+this.getClass().getSimpleName()+" Error occured while syncing dataload of Account from ODS to OSC",e);
			setErrorLog(e,"Un-expected error while syncing Companyt from ODS to OSC. Trace: ");
