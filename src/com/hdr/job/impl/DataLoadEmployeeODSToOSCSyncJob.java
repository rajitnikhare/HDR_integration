...
@Service
public class DataLoadEmployeeODSToOSCSyncJob extends AbstractSpringJob {
	
	private static final Logger log =  Logger.getLogger(DataLoadEmployeeODSToOSCSyncJob.class);
	
	@Resource(name="dataLoadSyncEmployeeODSToOSC")
	...
	protected void executeJob() throws Exception {
		try {
			...
			setErrorLog(e,"Un-expected error while Data Load Employee from ODS to OSC. Trace: ");
		}
	}
