...
@Service
public class CompanyODSToOSCSyncJob  extends AbstractSpringJob{
	
	
private static final Logger log =  Logger.getLogger(ProjectODSToOSCSyncJob.class);
	
	@Resource(name="syncCompanyODSToOSC")
	...
	protected void executeJob() throws Exception {
		try {
			...
			log.error("In "+this.getClass().getSimpleName()+" Error occured while syncing Account from ODS to OSC",e);
