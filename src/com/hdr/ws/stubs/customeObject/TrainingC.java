...
/**
 * <p>Java class for Training_c complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="Training_c">
 *   &lt;complexContent>
 ...
 *         &lt;element name="HDRTraining_c" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/>
 *         &lt;element name="Date_c" type="{http://xmlns.oracle.com/adf/svc/types/}date-Date" minOccurs="0"/>
 *         &lt;element name="ExpirationDate_c" type="{http://xmlns.oracle.com/adf/svc/types/}date-Date" minOccurs="0"/>
 *         &lt;element name="TrainingDescription_c" type="{http://xmlns.oracle.com/adf/svc/types/}base64Binary-DataHandler" minOccurs="0"/>
 *         &lt;element name="Provider_c" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *         &lt;element name="DONotPublish_c" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/>
 *         &lt;element name="IntegratedTraining_c" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/>
 *         &lt;element name="TrainingTypeCode_c" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "Training_c", propOrder = {
    "id",
    "recordName",
    "createdBy",
    "creationDate",
    ...
    "dateC",
    "expirationDateC",
    "trainingDescriptionC",
    "providerC",
    "doNotPublishC",
    "integratedTrainingC",
    "trainingTypeCodeC"
})
@XmlRootElement(name = "training_c")
public class TrainingC {
    ...
    @XmlElement(name = "HDRTraining_c")
    protected Boolean hdrTrainingC;
    @XmlElementRef(name = "Date_c", namespace = "/oracle/apps/sales/custExtn/views/common/", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> dateC;
    @XmlElementRef(name = "ExpirationDate_c", namespace = "/oracle/apps/sales/custExtn/views/common/", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> expirationDateC;
    @XmlElementRef(name = "TrainingDescription_c", namespace = "/oracle/apps/sales/custExtn/views/common/", type = JAXBElement.class, required = false)
    protected JAXBElement<byte[]> trainingDescriptionC;
    @XmlElementRef(name = "Provider_c", namespace = "/oracle/apps/sales/custExtn/views/common/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> providerC;
    @XmlElement(name = "DONotPublish_c")
    protected Boolean doNotPublishC;
    @XmlElement(name = "IntegratedTraining_c")
    protected Boolean integratedTrainingC;
    @XmlElementRef(name = "TrainingTypeCode_c", namespace = "/oracle/apps/sales/custExtn/views/common/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> trainingTypeCodeC;
    ...
    /**
     * Gets the value of the hdrTrainingC property.
     * 
     * @return
     *     possible object is
     *     {@link Boolean }
     *     
     */
    public Boolean isHDRTrainingC() {
        return hdrTrainingC;
    }

    /**
     * Sets the value of the hdrTrainingC property.
     * 
     * @param value
     *     allowed object is
     *     {@link Boolean }
     *     
     */
    public void setHDRTrainingC(Boolean value) {
        this.hdrTrainingC = value;
    }

    /**
     * Gets the value of the dateC property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link XMLGregorianCalendar }{@code >}
     *     
     */
    public JAXBElement<XMLGregorianCalendar> getDateC() {
        return dateC;
    }

    /**
     * Sets the value of the dateC property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link XMLGregorianCalendar }{@code >}
     *     
     */
    public void setDateC(JAXBElement<XMLGregorianCalendar> value) {
        this.dateC = value;
    }

    /**
     * Gets the value of the expirationDateC property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link XMLGregorianCalendar }{@code >}
     *     
     */
    public JAXBElement<XMLGregorianCalendar> getExpirationDateC() {
        return expirationDateC;
    }

    /**
     * Sets the value of the expirationDateC property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link XMLGregorianCalendar }{@code >}
     *     
     */
    public void setExpirationDateC(JAXBElement<XMLGregorianCalendar> value) {
        this.expirationDateC = value;
    }

    /**
     * Gets the value of the trainingDescriptionC property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public JAXBElement<byte[]> getTrainingDescriptionC() {
        return trainingDescriptionC;
    }

    /**
     * Sets the value of the trainingDescriptionC property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link byte[]}{@code >}
     *     
     */
    public void setTrainingDescriptionC(JAXBElement<byte[]> value) {
        this.trainingDescriptionC = value;
    }

    /**
     * Gets the value of the providerC property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public JAXBElement<String> getProviderC() {
        return providerC;
    }

    /**
     * Sets the value of the providerC property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public void setProviderC(JAXBElement<String> value) {
    ...
    /**
     * Gets the value of the integratedTrainingC property.
     * 
     * @return
     *     possible object is
     *     {@link Boolean }
     *     
     */
    public Boolean isIntegratedTrainingC() {
        return integratedTrainingC;
    }

    /**
     * Sets the value of the integratedTrainingC property.
     * 
     * @param value
     *     allowed object is
     *     {@link Boolean }
     *     
     */
    public void setIntegratedTrainingC(Boolean value) {
        this.integratedTrainingC = value;
    }

    /**
     * Gets the value of the trainingTypeCodeC property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public JAXBElement<String> getTrainingTypeCodeC() {
        return trainingTypeCodeC;
    }

    /**
     * Sets the value of the trainingTypeCodeC property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public void setTrainingTypeCodeC(JAXBElement<String> value) {
        this.trainingTypeCodeC = value;
    }
