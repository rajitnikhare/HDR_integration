...
/**
 * <p>Java class for CurrencyDailyRate_c complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="CurrencyDailyRate_c">
 *   &lt;complexContent>
 ...
 *         &lt;element name="ConversionRate_c" type="{http://xmlns.oracle.com/adf/svc/types/}AmountType" minOccurs="0"/>
 *         &lt;element name="InverseRate_c" type="{http://xmlns.oracle.com/adf/svc/types/}AmountType" minOccurs="0"/>
 *         &lt;element name="FROM_CURRENCY_c" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *         &lt;element name="TO_CURRENCY_c" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *         &lt;element name="ConversionRates_c" type="{http://www.w3.org/2001/XMLSchema}decimal" minOccurs="0"/>
 *         &lt;element name="ConversionDate_c" type="{http://xmlns.oracle.com/adf/svc/types/}date-Date" minOccurs="0"/>
 *         &lt;element name="ConversionDates_c" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "CurrencyDailyRate_c", propOrder = {
    "id",
    "recordName",
    "createdBy",
    "creationDate",
...
@XmlRootElement(name = "currencyDailyRate_c")
public class CurrencyDailyRateC {
    ...
    @XmlElementRef(name = "ConversionRate_c", namespace = "/oracle/apps/sales/custExtn/views/common/", type = JAXBElement.class, required = false)
    protected JAXBElement<AmountType> conversionRateC;
    @XmlElementRef(name = "InverseRate_c", namespace = "/oracle/apps/sales/custExtn/views/common/", type = JAXBElement.class, required = false)
    protected JAXBElement<AmountType> inverseRateC;
    @XmlElementRef(name = "FROM_CURRENCY_c", namespace = "/oracle/apps/sales/custExtn/views/common/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> fromcurrencyc;
    @XmlElementRef(name = "TO_CURRENCY_c", namespace = "/oracle/apps/sales/custExtn/views/common/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> tocurrencyc;
    @XmlElementRef(name = "ConversionRates_c", namespace = "/oracle/apps/sales/custExtn/views/common/", type = JAXBElement.class, required = false)
    protected JAXBElement<BigDecimal> conversionRatesC;
    ...
    @XmlElementRef(name = "ConversionDates_c", namespace = "/oracle/apps/sales/custExtn/views/common/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> conversionDatesC;
    ...
    /**
     * Gets the value of the conversionRateC property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public JAXBElement<AmountType> getConversionRateC() {
        return conversionRateC;
    }

    /**
     * Sets the value of the conversionRateC property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link AmountType }{@code >}
     *     
     */
    public void setConversionRateC(JAXBElement<AmountType> value) {
        this.conversionRateC = value;
    }

    /**
     * Gets the value of the inverseRateC property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link AmountType }{@code >}
     *     
     */
    public JAXBElement<AmountType> getInverseRateC() {
        return inverseRateC;
    }

    /**
     * Sets the value of the inverseRateC property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link AmountType }{@code >}
     *     
     */
    public void setInverseRateC(JAXBElement<AmountType> value) {
        this.inverseRateC = value;
    }

    /**
     * Gets the value of the fromcurrencyc property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public JAXBElement<String> getFROMCURRENCYC() {
        return fromcurrencyc;
    }

    /**
     * Sets the value of the fromcurrencyc property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public void setFROMCURRENCYC(JAXBElement<String> value) {
        this.fromcurrencyc = value;
    }

    /**
     * Gets the value of the tocurrencyc property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public JAXBElement<String> getTOCURRENCYC() {
        return tocurrencyc;
    }

    /**
     * Sets the value of the tocurrencyc property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public void setTOCURRENCYC(JAXBElement<String> value) {
        this.tocurrencyc = value;
    }

    /**
     * Gets the value of the conversionRatesC property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link BigDecimal }{@code >}
     *     
     */
    public JAXBElement<BigDecimal> getConversionRatesC() {
        return conversionRatesC;
    }

    /**
     * Sets the value of the conversionRatesC property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link BigDecimal }{@code >}
     *     
     */
    public void setConversionRatesC(JAXBElement<BigDecimal> value) {
        this.conversionRatesC = value;
    }
    ...
    /**
     * Gets the value of the conversionDatesC property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public JAXBElement<String> getConversionDatesC() {
        return conversionDatesC;
    }

    /**
     * Sets the value of the conversionDatesC property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public void setConversionDatesC(JAXBElement<String> value) {
        this.conversionDatesC = value;
    }
