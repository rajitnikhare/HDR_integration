 ...
 *         &lt;element name="StartDates_c" type="{http://xmlns.oracle.com/adf/svc/types/}dateTime-Timestamp" minOccurs="0"/>
 *         &lt;element name="EndDate_c" type="{http://xmlns.oracle.com/adf/svc/types/}dateTime-Timestamp" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class Note {
    ...
    @XmlElementRef(name = "StartDate_c", namespace = "http://xmlns.oracle.com/apps/crmCommon/notes/noteService", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> startDateC;
    @XmlElementRef(name = "StartDates_c", namespace = "http://xmlns.oracle.com/apps/crmCommon/notes/noteService", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> startDatesC;
    @XmlElementRef(name = "EndDate_c", namespace = "http://xmlns.oracle.com/apps/crmCommon/notes/noteService", type = JAXBElement.class, required = false)
    ...
    /**
     * Gets the value of the startDatesC property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link XMLGregorianCalendar }{@code >}
     *     
     */
    public JAXBElement<XMLGregorianCalendar> getStartDatesC() {
        return startDatesC;
    }

    /**
     * Sets the value of the startDatesC property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link XMLGregorianCalendar }{@code >}
     *     
     */
    public void setStartDatesC(JAXBElement<XMLGregorianCalendar> value) {
        this.startDatesC = value;
    }
