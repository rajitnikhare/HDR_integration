...
/**
 * <p>Java class for Contact_Distribution_List_c complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="Contact_Distribution_List_c">
 *   &lt;complexContent>
 ...
 *         &lt;element name="Person_Id_Src_PersonToContact_Distribution_List_c" type="{http://www.w3.org/2001/XMLSchema}decimal" minOccurs="0"/>
 *         &lt;element name="DistributionList_Id_Tgt_DistributionList_cToContact_Distribution_List_c" type="{http://www.w3.org/2001/XMLSchema}decimal" minOccurs="0"/>
...
@XmlType(name = "Contact_Distribution_List_c", namespace = "/oracle/apps/cdm/foundation/custextn/views/common/", propOrder = {
    "id",
    "recordName",
    "createdBy",
    "creationDate",
    ...
    "corpCurrencyCode",
    "isOwner",
    "personIdSrcPersonToContactDistributionListC",
    "distributionListIdTgtDistributionListCToContactDistributionListC",
    "callTypeC",
    "doNotCallC",
    "doNotEmailC",
    "doNotMailC",
...
public class ContactDistributionListC {
    ...
    @XmlElementRef(name = "Person_Id_Src_PersonToContact_Distribution_List_c", namespace = "/oracle/apps/cdm/foundation/custextn/views/common/", type = JAXBElement.class, required = false)
    protected JAXBElement<BigDecimal> personIdSrcPersonToContactDistributionListC;
    @XmlElementRef(name = "DistributionList_Id_Tgt_DistributionList_cToContact_Distribution_List_c", namespace = "/oracle/apps/cdm/foundation/custextn/views/common/", type = JAXBElement.class, required = false)
    protected JAXBElement<BigDecimal> distributionListIdTgtDistributionListCToContactDistributionListC;
    @XmlElementRef(name = "CallType_c", namespace = "/oracle/apps/cdm/foundation/custextn/views/common/", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "EmailType_c", namespace = "/oracle/apps/cdm/foundation/custextn/views/common/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> emailTypeC;
    @XmlElementRef(name = "MailType_c", namespace = "/oracle/apps/cdm/foundation/custextn/views/common/", type = JAXBElement.class, required = false)
    ...
    /**
     * Gets the value of the personIdSrcPersonToContactDistributionListC property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link BigDecimal }{@code >}
     *     
     */
    public JAXBElement<BigDecimal> getPersonIdSrcPersonToContactDistributionListC() {
        return personIdSrcPersonToContactDistributionListC;
    }

    /**
     * Sets the value of the personIdSrcPersonToContactDistributionListC property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link BigDecimal }{@code >}
     *     
     */
    public void setPersonIdSrcPersonToContactDistributionListC(JAXBElement<BigDecimal> value) {
        this.personIdSrcPersonToContactDistributionListC = value;
    }

    /**
     * Gets the value of the distributionListIdTgtDistributionListCToContactDistributionListC property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link BigDecimal }{@code >}
     *     
     */
    public JAXBElement<BigDecimal> getDistributionListIdTgtDistributionListCToContactDistributionListC() {
        return distributionListIdTgtDistributionListCToContactDistributionListC;
    }

    /**
     * Sets the value of the distributionListIdTgtDistributionListCToContactDistributionListC property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link BigDecimal }{@code >}
     *     
     */
    public void setDistributionListIdTgtDistributionListCToContactDistributionListC(JAXBElement<BigDecimal> value) {
        this.distributionListIdTgtDistributionListCToContactDistributionListC = value;
    }
