...
public class PartyUsageAssignment {
    ...
    @XmlElementRef(name = "EffectiveEndDate", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/partyService/", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "OwnerTableName", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/partyService/", type = JAXBElement.class, required = false)
