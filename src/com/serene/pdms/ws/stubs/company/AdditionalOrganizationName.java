...
public class AdditionalOrganizationName {
    ...
    @XmlElementRef(name = "PreferredFlag", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/organizationService/", type = JAXBElement.class, required = false)
    protected JAXBElement<Boolean> preferredFlag;
    @XmlElementRef(name = "Description", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/organizationService/", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "TransliterationLang", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/organizationService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> transliterationLang;
    @XmlElementRef(name = "PartyName", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/organizationService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> partyName;
    @XmlElementRef(name = "OverallPreferredFlag", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/organizationService/", type = JAXBElement.class, required = false)
