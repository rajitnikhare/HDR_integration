...
public class SalesAccountResource {
    ...
    @XmlElementRef(name = "AccountDirectorId", namespace = "http://xmlns.oracle.com/apps/crmCommon/salesParties/salesPartiesService/", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "BusinessUnit_c", namespace = "http://xmlns.oracle.com/apps/crmCommon/salesParties/salesPartiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> businessUnitC;
    @XmlElementRef(name = "BusinessUnit_cMeaning", namespace = "http://xmlns.oracle.com/apps/crmCommon/salesParties/salesPartiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> businessUnitCMeaning;
    @XmlElementRef(name = "Department_c", namespace = "http://xmlns.oracle.com/apps/crmCommon/salesParties/salesPartiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> departmentC;
    @XmlElementRef(name = "Department_cMeaning", namespace = "http://xmlns.oracle.com/apps/crmCommon/salesParties/salesPartiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> departmentCMeaning;
    @XmlElementRef(name = "Amount_c", namespace = "http://xmlns.oracle.com/apps/crmCommon/salesParties/salesPartiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<AmountType> amountC;
    @XmlElementRef(name = "Amount_cCurrencyCode", namespace = "http://xmlns.oracle.com/apps/crmCommon/salesParties/salesPartiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> amountCCurrencyCode;
    @XmlElementRef(name = "Amount_cCurcyConvRate", namespace = "http://xmlns.oracle.com/apps/crmCommon/salesParties/salesPartiesService/", type = JAXBElement.class, required = false)
    protected JAXBElement<BigDecimal> amountCCurcyConvRate;
    @XmlElementRef(name = "Title_c", namespace = "http://xmlns.oracle.com/apps/crmCommon/salesParties/salesPartiesService/", type = JAXBElement.class, required = false)
