...
public class SalesAccountResourceAccess {
    ...
    @XmlElementRef(name = "SalesAccountId", namespace = "http://xmlns.oracle.com/apps/crmCommon/salesParties/salesPartiesService/", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "UserGUID", namespace = "http://xmlns.oracle.com/apps/crmCommon/salesParties/salesPartiesService/", type = JAXBElement.class, required = false)
