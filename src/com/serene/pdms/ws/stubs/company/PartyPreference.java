...
public class PartyPreference {
    ...
    @XmlElementRef(name = "Module", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/partyService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> module;
    @XmlElement(name = "Category")
    protected String category;
    @XmlElement(name = "PreferenceCode")
    protected String preferenceCode;
    @XmlElementRef(name = "ValueVarchar2", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/partyService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> valueVarchar2;
    @XmlElementRef(name = "ValueNumber", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/partyService/", type = JAXBElement.class, required = false)
    protected JAXBElement<BigDecimal> valueNumber;
    @XmlElementRef(name = "ValueDate", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/partyService/", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> valueDate;
    @XmlElementRef(name = "ValueName", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/partyService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> valueName;
    @XmlElementRef(name = "AdditionalValue1", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/partyService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> additionalValue1;
    @XmlElementRef(name = "AdditionalValue2", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/partyService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> additionalValue2;
    @XmlElementRef(name = "AdditionalValue3", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/partyService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> additionalValue3;
    @XmlElementRef(name = "AdditionalValue4", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/partyService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> additionalValue4;
    @XmlElementRef(name = "AdditionalValue5", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/partyService/", type = JAXBElement.class, required = false)
