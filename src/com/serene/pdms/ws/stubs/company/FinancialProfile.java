...
public class FinancialProfile {
    ...
    @XmlElementRef(name = "AccessAuthorityDate", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/partyService/", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> accessAuthorityDate;
    @XmlElementRef(name = "AccessAuthorityGranted", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/partyService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> accessAuthorityGranted;
    @XmlElementRef(name = "BalanceAmount", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/partyService/", type = JAXBElement.class, required = false)
    protected JAXBElement<AmountType> balanceAmount;
    @XmlElementRef(name = "BalanceVerifiedOnDate", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/partyService/", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> balanceVerifiedOnDate;
    @XmlElementRef(name = "FinancialAccountNumber", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/partyService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> financialAccountNumber;
    @XmlElementRef(name = "FinancialAccountType", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/partyService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> financialAccountType;
    @XmlElementRef(name = "FinancialOrgType", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/partyService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> financialOrgType;
    @XmlElementRef(name = "FinancialOrganizationName", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/partyService/", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "PreferredFunctionalCurrency", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/partyService/", type = JAXBElement.class, required = false)
    ...
    public void setAccessAuthorityDate(JAXBElement<XMLGregorianCalendar> value) {
        this.accessAuthorityDate = value;
    }
    ...
    public void setAccessAuthorityGranted(JAXBElement<String> value) {
        this.accessAuthorityGranted = value;
    }
    ...
    public void setBalanceVerifiedOnDate(JAXBElement<XMLGregorianCalendar> value) {
        this.balanceVerifiedOnDate = value;
    }
    ...
    public void setFinancialAccountType(JAXBElement<String> value) {
        this.financialAccountType = value;
    }
    ...
    public void setFinancialOrganizationName(JAXBElement<String> value) {
        this.financialOrganizationName = value;
    }
