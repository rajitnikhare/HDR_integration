...
public class Eft {
    ...
    @XmlElementRef(name = "EFTTransmissionProgramId", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/contactPointService/", type = JAXBElement.class, required = false)
    protected JAXBElement<Long> eftTransmissionProgramId;
    @XmlElementRef(name = "EFTPrintingProgramId", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/contactPointService/", type = JAXBElement.class, required = false)
    protected JAXBElement<Long> eftPrintingProgramId;
    @XmlElementRef(name = "EFTUserNumber", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/contactPointService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> eftUserNumber;
    @XmlElementRef(name = "EFTSWIFTCode", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/contactPointService/", type = JAXBElement.class, required = false)
    ...
    public void setEFTTransmissionProgramId(JAXBElement<Long> value) {
        this.eftTransmissionProgramId = value;
    }
    ...
    public void setEFTPrintingProgramId(JAXBElement<Long> value) {
        this.eftPrintingProgramId = value;
    }
