...
public class Group {
    ...
    @XmlElementRef(name = "GroupSize", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/groupService/", type = JAXBElement.class, required = false)
    protected JAXBElement<Long> groupSize;
    @XmlElement(name = "PartyUniqueName")
    protected String partyUniqueName;
    @XmlElementRef(name = "UniqueNameSuffix", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/groupService/", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "AnnualIncome", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/groupService/", type = JAXBElement.class, required = false)
    protected JAXBElement<Long> annualIncome;
    @XmlElementRef(name = "AnnualExpenses", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/groupService/", type = JAXBElement.class, required = false)
    protected JAXBElement<Long> annualExpenses;
    @XmlElementRef(name = "AverageAge", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/groupService/", type = JAXBElement.class, required = false)
    protected JAXBElement<Long> averageAge;
    @XmlElementRef(name = "Child0to6Number", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/groupService/", type = JAXBElement.class, required = false)
    protected JAXBElement<Long> child0To6Number;
    @XmlElementRef(name = "Child13to18Number", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/groupService/", type = JAXBElement.class, required = false)
    protected JAXBElement<Long> child13To18Number;
    @XmlElementRef(name = "Child7to12Number", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/groupService/", type = JAXBElement.class, required = false)
    protected JAXBElement<Long> child7To12Number;
    @XmlElementRef(name = "DependentsNumber", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/groupService/", type = JAXBElement.class, required = false)
    protected JAXBElement<Long> dependentsNumber;
    @XmlElementRef(name = "CertificationReasonCode", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/groupService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> certificationReasonCode;
    @XmlElementRef(name = "CertificationLevel", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/groupService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> certificationLevel;
    @XmlElementRef(name = "Comments", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/groupService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> comments;
    @XmlElementRef(name = "MedianAge", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/groupService/", type = JAXBElement.class, required = false)
    protected JAXBElement<Long> medianAge;
    @XmlElementRef(name = "WealthAmount", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/groupService/", type = JAXBElement.class, required = false)
    protected JAXBElement<AmountType> wealthAmount;
    @XmlElementRef(name = "PreferredFunctionalCurrency", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/groupService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> preferredFunctionalCurrency;
    @XmlElementRef(name = "PreferredContactMethod", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/groupService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> preferredContactMethod;
    @XmlElementRef(name = "PreferredName", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/groupService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> preferredName;
    @XmlElementRef(name = "PreferredNameId", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/groupService/", type = JAXBElement.class, required = false)
    protected JAXBElement<Long> preferredNameId;
    @XmlElementRef(name = "ValidatedFlag", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/groupService/", type = JAXBElement.class, required = false)
    protected JAXBElement<Boolean> validatedFlag;
    @XmlElementRef(name = "PrimaryAddressCountry", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/groupService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> primaryAddressCountry;
    @XmlElementRef(name = "PrimaryAddressLine1", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/groupService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> primaryAddressLine1;
    @XmlElementRef(name = "PrimaryAddressLine2", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/groupService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> primaryAddressLine2;
    @XmlElementRef(name = "PrimaryAddressLine3", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/groupService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> primaryAddressLine3;
    @XmlElementRef(name = "PrimaryAddressLine4", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/groupService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> primaryAddressLine4;
    @XmlElementRef(name = "PrimaryAddressCity", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/groupService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> primaryAddressCity;
    @XmlElementRef(name = "PrimaryAddressCounty", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/groupService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> primaryAddressCounty;
    @XmlElementRef(name = "PrimaryAddressState", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/groupService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> primaryAddressState;
    @XmlElementRef(name = "PrimaryAddressProvince", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/groupService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> primaryAddressProvince;
    @XmlElementRef(name = "PrimaryAddressPostalCode", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/groupService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> primaryAddressPostalCode;
    @XmlElementRef(name = "PrimaryFormattedAddress", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/groupService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> primaryFormattedAddress;
    @XmlElementRef(name = "PrimaryFormattedMultilineAddress", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/groupService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> primaryFormattedMultilineAddress;
    @XmlElementRef(name = "PrimaryAddressPartySiteId", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/groupService/", type = JAXBElement.class, required = false)
    protected JAXBElement<Long> primaryAddressPartySiteId;
    @XmlElementRef(name = "PrimaryAddressLocationId", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/groupService/", type = JAXBElement.class, required = false)
    protected JAXBElement<Long> primaryAddressLocationId;
    @XmlElementRef(name = "PrimaryPhonePurpose", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/groupService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> primaryPhonePurpose;
    @XmlElementRef(name = "PrimaryPhoneLineType", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/groupService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> primaryPhoneLineType;
    @XmlElementRef(name = "PrimaryPhoneCountryCode", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/groupService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> primaryPhoneCountryCode;
    @XmlElementRef(name = "PrimaryPhoneAreaCode", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/groupService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> primaryPhoneAreaCode;
    @XmlElementRef(name = "PrimaryPhoneNumber", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/groupService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> primaryPhoneNumber;
    @XmlElementRef(name = "PrimaryPhoneExtension", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/groupService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> primaryPhoneExtension;
    @XmlElementRef(name = "PrimaryFormattedPhoneNumber", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/groupService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> primaryFormattedPhoneNumber;
    @XmlElementRef(name = "PrimaryPhoneId", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/groupService/", type = JAXBElement.class, required = false)
    protected JAXBElement<Long> primaryPhoneId;
    @XmlElementRef(name = "PrimaryEmail", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/groupService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> primaryEmail;
    @XmlElementRef(name = "PrimaryEmailId", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/groupService/", type = JAXBElement.class, required = false)
    protected JAXBElement<Long> primaryEmailId;
    @XmlElementRef(name = "PrimaryURL", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/groupService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> primaryURL;
    @XmlElementRef(name = "PrimaryWebId", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/groupService/", type = JAXBElement.class, required = false)
    protected JAXBElement<Long> primaryWebId;
    @XmlElementRef(name = "PreferredContactPersonName", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/groupService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> preferredContactPersonName;
    @XmlElementRef(name = "PreferredContactPersonPhone", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/groupService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> preferredContactPersonPhone;
    @XmlElementRef(name = "PreferredContactPersonEmail", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/groupService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> preferredContactPersonEmail;
    @XmlElementRef(name = "PreferredContactPersonURL", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/groupService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> preferredContactPersonURL;
    @XmlElementRef(name = "PreferredContactPersonId", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/groupService/", type = JAXBElement.class, required = false)
    protected JAXBElement<Long> preferredContactPersonId;
    @XmlElementRef(name = "PrimaryLanguage", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/groupService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> primaryLanguage;
    @XmlElement(name = "Status")
    protected String status;
    @XmlElementRef(name = "CreatedByModule", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/groupService/", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "LastUpdateLogin", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/groupService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> lastUpdateLogin;
    @XmlElementRef(name = "ProfileCreatedByModule", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/groupService/", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "ProfileLastUpdateLogin", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/groupService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> profileLastUpdateLogin;
    @XmlElementRef(name = "RequestId", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/groupService/", type = JAXBElement.class, required = false)
    protected JAXBElement<Long> requestId;
    @XmlElementRef(name = "CurrencyCode", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/groupService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> currencyCode;
    @XmlElementRef(name = "CorpCurrencyCode", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/groupService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> corpCurrencyCode;
    @XmlElementRef(name = "CurcyConvRateType", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/groupService/", type = JAXBElement.class, required = false)
    ...
    public void setPrimaryFormattedMultilineAddress(JAXBElement<String> value) {
        this.primaryFormattedMultilineAddress = value;
    }
    ...
    public void setPrimaryAddressPartySiteId(JAXBElement<Long> value) {
        this.primaryAddressPartySiteId = value;
    }
    ...
    public void setPreferredContactPersonName(JAXBElement<String> value) {
        this.preferredContactPersonName = value;
    }
    ...
    public void setPreferredContactPersonPhone(JAXBElement<String> value) {
        this.preferredContactPersonPhone = value;
    }
    ...
    public void setPreferredContactPersonEmail(JAXBElement<String> value) {
        this.preferredContactPersonEmail = value;
    }
    ...
    public void setPreferredContactPersonURL(JAXBElement<String> value) {
        this.preferredContactPersonURL = value;
    }
    ...
    public void setProfileCreatedByModule(JAXBElement<String> value) {
        this.profileCreatedByModule = value;
    }
    ...
    public void setProfileLastUpdateLogin(JAXBElement<String> value) {
        this.profileLastUpdateLogin = value;
    }
