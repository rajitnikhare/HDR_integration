...
public class PersonLanguage {
    ...
    @XmlElementRef(name = "PrimaryLanguageIndicator", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/partyService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> primaryLanguageIndicator;
    @XmlElementRef(name = "ReadsLevel", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/partyService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> readsLevel;
    @XmlElementRef(name = "SpeaksLevel", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/partyService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> speaksLevel;
    @XmlElementRef(name = "WritesLevel", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/partyService/", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "SpokenComprehensionLevel", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/partyService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> spokenComprehensionLevel;
    @XmlElementRef(name = "NativeLanguageFlag", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/partyService/", type = JAXBElement.class, required = false)
    ...
    public void setSpokenComprehensionLevel(JAXBElement<String> value) {
        this.spokenComprehensionLevel = value;
    }
