...
public class Citizenship {
    ...
    @XmlElementRef(name = "BirthOrSelected", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/personService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> birthOrSelected;
    @XmlElement(name = "PartyId")
    protected Long partyId;
    @XmlElement(name = "CountryCode")
    protected String countryCode;
    @XmlElementRef(name = "DateDisowned", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/personService/", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> dateDisowned;
    @XmlElementRef(name = "DateRecognized", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/personService/", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> dateRecognized;
    @XmlElementRef(name = "DocumentReference", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/personService/", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "DocumentType", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/personService/", type = JAXBElement.class, required = false)
