...
public class AdditionalGroupName {
    ...
    @XmlElementRef(name = "PreferredFlag", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/groupService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> preferredFlag;
    @XmlElementRef(name = "Description", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/groupService/", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "TransliterationLang", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/groupService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> transliterationLang;
    @XmlElementRef(name = "PartyName", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/groupService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> partyName;
    @XmlElementRef(name = "OverallPreferredFlag", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/groupService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> overallPreferredFlag;
    @XmlElementRef(name = "OrigSystem", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/groupService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> origSystem;
    @XmlElementRef(name = "OrigSystemReference", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/groupService/", type = JAXBElement.class, required = false)
    ...
    public void setOverallPreferredFlag(JAXBElement<String> value) {
        this.overallPreferredFlag = value;
    }
