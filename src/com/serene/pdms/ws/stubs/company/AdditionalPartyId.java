...
public class AdditionalPartyId {
    ...
    @XmlElementRef(name = "PartyName", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/partyService/", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "Country", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/partyService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> country;
    @XmlElementRef(name = "StateProvince", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/partyService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> stateProvince;
    @XmlElementRef(name = "IssuingAuthorityName", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/partyService/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> issuingAuthorityName;
    @XmlElementRef(name = "IssuingAuthorityPartyId", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/partyService/", type = JAXBElement.class, required = false)
    protected JAXBElement<Long> issuingAuthorityPartyId;
    @XmlElementRef(name = "IssueDate", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/partyService/", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> issueDate;
    @XmlElementRef(name = "ExpirationDate", namespace = "http://xmlns.oracle.com/apps/cdm/foundation/parties/partyService/", type = JAXBElement.class, required = false)
    ...
    public void setIssuingAuthorityPartyId(JAXBElement<Long> value) {
        this.issuingAuthorityPartyId = value;
    }
